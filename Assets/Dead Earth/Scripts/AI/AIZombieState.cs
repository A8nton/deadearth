...
public abstract class AIZombieState : AIState {
	...
	public override void OnTriggerEvent(AITriggerEventType eventType, Collider other) {
		...
		if (eventType != AITriggerEventType.Exit) {
			...
			if (other.CompareTag("Flash Light") && curType != AITargetType.VisualPlayer) {
			...
			if (other.CompareTag("AI Food") && curType != AITargetType.VisualPlayer && curType != AITargetType.VisualLight &&
